...
var Dialog = function Dialog(props, ref) {
  var _props$prefix = props.prefix,
    ...
    text: ''
      ...
      others = __rest(props, ["prefix", "visible", "type", "platform", "title", "content", "contentClassName", "closeMode", "footerActions", "vibrative", "footer", "centered", "okProps", "cancelProps", "className", "children", "onOk", "onCancel", "onClose"]);
  ...
  var clses = useMemo(function () {
    ...
    return {
      ...
      content: classNames(contentClassName, (_classNames8 = {}, _defineProperty(_classNames8, "".concat(clsPrefix, "-content"), !centered), _defineProperty(_classNames8, "".concat(clsPrefix, "-content--centered ").concat(clsPrefix, "-content--centered-").concat(platform), centered), _classNames8)),
