...
:root {
  ...
  */
  ...
  /*
    @desc small-preview-input-size
    @namespace size/preview-input
    @semantic 预览字号(小)
  */
  --form-preview-small-font-size: var(--p-body-1-font-size);
  /*
    @desc medium-preview-input-size
    @namespace size/preview-input
    @semantic 预览字号(中)
  */
  --form-preview-medium-font-size: var(--p-body-2-font-size);
  /*
    @desc large-preview-input-size
    @namespace size/preview-input
    @semantic 预览字号(大)
  */
  ...
  .mt-form-item {
    ...
    .mt-form-item-label {
      ...
      .mt-form-item-label-container {
        ...
        .mt-form-item-label-container > *,
        .mt-form-item-label-container > .rax-text,
        .mt-form-item-label-container > .h5-span,
        .mt-form-item-label-container > text {
          display: inline; }
...
:root {
  ...
  /*
   @desc color
   @namespace card/color
   @semantic 已选中项目颜色（文字、边框）
   */
