...
var BottomButton = function BottomButton(props) {
  ...
  var clses = {
    bottomBtn: classNames(clsPrefix, className, (_classNames = {}, _defineProperty(_classNames, "".concat(clsPrefix, "--dividing"), showDividingLine), _defineProperty(_classNames, "".concat(clsPrefix, "--safe"), enableSafeArea), _classNames)),
