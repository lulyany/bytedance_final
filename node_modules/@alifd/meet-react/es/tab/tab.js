...
var Tab = function Tab(props, ref) {
  ...
  var clses = {
    ...
    container: classNames((_classNames2 = {}, _defineProperty(_classNames2, "".concat(clsPrefix, "-container"), true), _defineProperty(_classNames2, "".concat(clsPrefix, "-container--").concat(size), true), _defineProperty(_classNames2, "".concat(clsPrefix, "-container--wechat"), isStrictWechatMiniProgram), _classNames2)),
