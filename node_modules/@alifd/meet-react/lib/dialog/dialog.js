...
var Dialog = function (props, ref) {
  var _props$prefix = props.prefix,
    ...
    text: ''
      ...
      others = (0, _tslib.__rest)(props, ["prefix", "visible", "type", "platform", "title", "content", "contentClassName", "closeMode", "footerActions", "vibrative", "footer", "centered", "okProps", "cancelProps", "className", "children", "onOk", "onCancel", "onClose"]);
  ...
  var clses = (0, _react.useMemo)(function () {
    ...
    return {
      ...
      icon: (0, _classnames.default)(clsPrefix + "-icon " + clsPrefix + "-icon--" + type, (_classNames6 = {}, _classNames6[clsPrefix + "-icon--centered"] = centered, _classNames6)),
  ...
  }, !centered && iconName ? /*#__PURE__*/(0, _react.createElement)(_icon.default, {
    name: iconName,
...
var _default = /*#__PURE__*/(0, _react.forwardRef)(Dialog);
