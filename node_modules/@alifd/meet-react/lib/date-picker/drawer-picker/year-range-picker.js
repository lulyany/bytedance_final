...
var _yearPicker = _interopRequireDefault(require("../embed-picker/year-picker"));
...
var YearRangePicker = /*#__PURE__*/function (_BaseRangePicker) {
  _inheritsLoose(YearRangePicker, _BaseRangePicker);

  function YearRangePicker() {
    return _BaseRangePicker.apply(this, arguments) || this;
  }

  var _proto = YearRangePicker.prototype;
  ...
  _proto.renderBase = function renderBase(value, validRange, onChange) {
    return /*#__PURE__*/(0, _react.createElement)(_yearPicker.default, {
      value: value,
...
var _default = (0, _locale.withLocale)(YearRangePicker, {
