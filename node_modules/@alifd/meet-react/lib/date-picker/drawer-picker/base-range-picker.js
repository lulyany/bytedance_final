...
var _utils2 = require("../../time-picker/utils");
...
var BaseRangePicker = /*#__PURE__*/function (_Component) {
  ...
  function BaseRangePicker(props) {
    ...
    _this.handleOk = function () {
      ...
      if (startDate && endDate && (0, _dayjs.default)(startDate).isAfter(endDate)) {
  ...
  _createClass(BaseRangePicker, [{
    ...
    get: function get() {
      ...
      return typeof showTime === 'object' && showTime.format ? showTime.format : _utils2.DEFAULT_FORMAT;
    }
  }, {
    key: "format",
    get: function get() {
