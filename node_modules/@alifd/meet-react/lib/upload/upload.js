...
var Upload = function (props, ref) {
  ...
  var _useState = (0, _react.useState)('0px'),
      itemSize = _useState[0],
      setItemSize = _useState[1];

  var _useState2 = (0, _react.useState)(valueProp || defaultValue || []),
      value = _useState2[0],
  ...
  var uploadId = (0, _hooks.useGuid)('mtUpload');
          ...
          return regeneratorRuntime.wrap(function (_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  _context.next = 2;
                  return (0, _utils.getWidth)(uploadId);

                case 2:
                  width = _context.sent;
                  newCardSize = "calc(((" + width + "px - var(--upload-card-spacing)*3 )) / 4)";
  ...
  var handleAdd = (0, _react.useCallback)(function () {
    return (0, _tslib.__awaiter)(void 0, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
