...
var NumberPickerField = /*#__PURE__*/function (_FieldElement) {
  _inheritsLoose(NumberPickerField, _FieldElement);

  function NumberPickerField() {
    return _FieldElement.apply(this, arguments) || this;
  }

  var _proto = NumberPickerField.prototype;

  _proto.renderControl = function renderControl() {
    return /*#__PURE__*/(0, _react.createElement)(_numberPicker.default, this.getProps());
  };
