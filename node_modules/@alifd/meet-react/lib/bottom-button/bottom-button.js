...
var BottomButton = function (props) {
  ...
  var _props$prefix = props.prefix,
      ...
      others = (0, _tslib.__rest)(props, ["prefix", "actions", "size", "okText", "cancelText", "className", "okProps", "cancelProps", "enableSafeArea", "showDividingLine", "children", "onOk", "onCancel"]);
  var clsPrefix = prefix + "bottom-btn";
  var clses = {
    bottomBtn: (0, _classnames.default)(clsPrefix, className, (_classNames = {}, _classNames[clsPrefix + "--dividing"] = showDividingLine, _classNames[clsPrefix + "--safe"] = enableSafeArea, _classNames)),
