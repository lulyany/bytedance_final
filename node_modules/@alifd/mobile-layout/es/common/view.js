...
var isStrictMiniApp = !isWeb && isMiniApp;
var View = forwardRef(function (props, ref) {
  var selfRef = useRef(null); // automatically remove onTouch* events on view template. set withoutTouch=false to add all events in miniapp
  ...
  var newClsName = classNames(className);

  if (isStrictMiniApp) {
    // For miniapp runtime pre-compile
    return withoutTouch ? createElement("view", _extends({}, rest, {
      ...
      ,
      ref: ref
    })) : createElement("div", _extends({}, rest, {
      className: newClsName,
      onAppear: onAppear,
      onDisappear: rest.onDisappear,
