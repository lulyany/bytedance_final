...
export var formatSystemInfo = function formatSystemInfo(api) {
  return function () {
    var res = api();
    return formatResult(res);
  };
};
export var formatResult = function formatResult(data) {
  var defaultData = {
    pixelRatio: 1,
    screenWidth: 0,
    screenHeight: 0,
...
export var formatSystemInfoAsync = function formatSystemInfoAsync(api, containerName) {
